...
//   return imageId ? `/resources/user-images/${imageId}` : AccountCircleIcon;
// }
...
export function checkUUID(
  ...
  message = `${uuid} is not a valid Id`,
): asserts uuid {
  invariantResponse(uuid !== undefined, message);
  const regexExp =
    /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/gi;

  invariantResponse(regexExp.test(uuid ?? ""), message);
}
